<div class="row">
  <!-- <div class="col-12"><input type="text" id="verifPuce" name="verifPuce" size=5 required="required" style="font-size:0.1px; height:1px; padding:0px" title="Selectionnez au moins une r&eacute;ponse"></div> -->
  <div class="col-md-3">
    <!-- checkbox -->
    <div class="form-group mb-1">
      <div class="form-check">
        <input class="form-check-input" type="checkbox" id="autresim_ooredoo" name="autresim[]" id="autrepuce[]" value="ooredoo">
  ...
  <div class="col-md-3">
    ...
    <div class="form-group mb-1">
      ...
      <div class="form-check">
        <input class="form-check-input" type="checkbox" id="autresim_mobilis" name="autresim[]" value="mobilis">
  ...
  <div class="col-md-3">
    ...
    <div class="form-group mb-1">
      <div class="form-check">
        <input class="form-check-input" type="checkbox" id="autresim_djezzy" name="autresim[]" value="djezzy">
...
<tr bgcolor="white">
  <td colspan="2">
    <div class="row">
      <div class="col-12" id="autrepuce_ooredoo" style="display:none">
          ...
          <div class="card-body">
            ...
            <div class="form-group mt-4">
              ...
              <select class="form-control" name="RaisonduchoixOoredoo[]" id="RaisonduchoixOoredoo" multiple>
                ...
                <option value="Autre">Autre</option>y
      ...
      <div class="col-12" id="autrepuce_mobilis" style="display:none">
      ...
      <div class="col-12" id="autrepuce_djezzy" style="display:none">
    ...
    </div> <!-- end row autres offres -->
    <br><br><br><br>
    <div class="row">

      <div class="col-12">
        <h6>Prise de conge :</h6>
        <b>Nous vous remercions Mme/M d avoir choisi Ooredoo.</b> <br><br>
        <b>Nous vous souhaitons une excellente journee.</b> <br><br>
        <b>Pour plus d informations, contactez le service client au <span class="badge badge-danger">333</span>, disponible <span class="badge badge-warning">7j/7 et 24h/24</span>.</b> <br><br>
        <h4> <b>A bientot</b> </h4><br><br>
      </div>

    </div>

    <div class="row">
      <div class="col-10 text-center"><button class="btn btn-lg btn-success">VALIDER</button></div>
    </div>