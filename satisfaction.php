    ...
    <div class="col-12" id="pas_satisfait_card" style="display:none">
      <div class="card card-danger">
        ...
        <div class="card-body">
          ...
          <select class="form-control" name="satisfaction" id="pas_satisfait">
            ...
            <option value="Pas assez de credit d appels vers les autres reseaux"> Pas assez de crédit d’appels vers les autres réseaux</option>
            <option value="C est complique de l activer"> C’est compliqué de l’activer</option>
            <option value="Le prix de la recharge est cher"> Le prix de la recharge est cher</option>
            <option value="C est un forfait qu on ne peut pas garder"> C’est un forfait qu’on ne peut pas garder</option>
            <option value="C est un forfait qu on peut renouveler une seule fois"> C’est un forfait qu’on peut renouveler une seule fois</option>
      ...
      <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title">Insatisfaction</h3>
          <hr> <b>
            <h4>Utilisez-vous, en ce moment, d’autres puces en plus de celle sur laquelle on vous appelle :</h4>
          </b>
        </div>
        <div class="card-body">
          <div class="row">
